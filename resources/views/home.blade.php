                ...
                <div class="col ps-4">
                   ...
                   @if (Auth::user()->role == "admin")
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> Total Professores</div>
                                        </div>
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <div class="col-3">
                            <span class="ps-2 me-2">Percentual de estudantes</span>
                  ...
                  @endif
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>Seja bem-vindo ao SIGISA_ISPB</h3>
                            </div>
                        </div>
                      {{--
                        <div class="col">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent d-flex justify-content-between"><span><i class="bi bi-megaphone me-2"></i> Anúncios</span> {{ $notices->links() }}</div>
                                <div class="card-body p-0 text-dark">
                                    <div>
                                        ...
                                        <div class="accordion accordion-flush" id="noticeAccordion">
                                            ...
                                            @endisset
                                            @if(count($notices) < 1)
                                                <div class="p-3">Sem Anúncios</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
